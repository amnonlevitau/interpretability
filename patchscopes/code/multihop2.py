...
def generate_multihop_data_ceo(fdir_out="./outputs/factual", batch_size=512 // batch_size_scale, max_gen_len=20, replace=False):
    ...
    # eval_results = generate_baseline_multihsqueue --meop(mt, df, batch_size=batch_size, max_gen_len=max_gen_len)
...
cot_correct_baseline = run_experiment(
    ...
    fname_out = f"combined_multihop_CoT_{model_name}_only_correct_True", batch_size=128 // batch_size_scale, n_samples=-1,
    save_output=True, replace=False)
